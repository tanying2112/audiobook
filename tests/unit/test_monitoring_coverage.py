...
class TestLangfuseClient:
    ...
    def get_langfuse_client_disabled(self):
        ...
        from src.audiobook_studio.monitoring.langfuse_client import (
            get_langfuse_client, init_langfuse
        )
    ...
    def test_is_enabled_false(self):
        ...
        from src.audiobook_studio.monitoring.langfuse_client import is_enabled, init_langfuse
        init_langfuse(enabled=False)
...
class TestDashboard:
    ...
    def test_detect_anomalies_low_success(self):
        ...
        summary = {
            "stages": {
                "test": {"success_rate": 0.5, "count": 10}
            }
        }
    ...
    def test_detect_anomalies_low_quality(self):
        ...
        summary = {
            "stages": {
                "test": {"quality_avg": 0.5, "count": 10, "success_rate": 1.0}
            }
        }
        anomalies = detect_anomalies(summary)
