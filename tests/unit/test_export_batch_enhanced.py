...
class TestExportChapter:
    ...
    @patch("src.audiobook_studio.export.batch_exporter.build_m4b")
    def test_export_chapter_success(self, mock_build_m4b, mock_path_class, mock_get_duration):
        ...
        with patch("src.audiobook_studio.export.batch_exporter._collect_chapter_data") as mock_collect:
            mock_collect.return_value = {"chapter": mock_chapter, "audio_segments": [mock_audio_segment]}
    ...
    @patch("src.audiobook_studio.export.batch_exporter.Path")
    @patch("src.audiobook_studio.export.batch_exporter.build_m4b")
    def test_export_chapter_with_fallback_duration(self, mock_build_m4b, mock_path_class, mock_get_duration):
