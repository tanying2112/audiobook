...
assert (
    result.segment_id == "test_seg_123"
), f"FAIL: Expected test_seg_123, got {result.segment_id}"
...
assert (
    result2.segment_id == "unknown"
), f"FAIL: Expected unknown, got {result2.segment_id}"
