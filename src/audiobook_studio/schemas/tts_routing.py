...
class TtsRoutingDecision(BaseModel):
    ...
    engine_choice: Literal["kokoro", "edge", "azure", "gcp", "human_clone"] = Field(..., description="选择的 TTS 引擎")
    ...
    fallback_engine: Literal["kokoro", "edge", "azure", "gcp", "human_clone"] = Field(..., description="降级引擎")
