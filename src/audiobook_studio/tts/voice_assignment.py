...
_DEFAULT_POOL: List[VoiceInfo] = [
    ...
    VoiceInfo(
        ...
        language="zh-CN",
        gender="female",
        description="Piper 中文女声 (默认旁白)",
        engine="piper",
        supports_reference_audio=False,
    ),
    VoiceInfo(
        voice_id="zh_CN-shaoer-medium",
        name="少儿",
        language="zh-CN",
        gender="neutral",
        description="Piper 中文少儿/活泼声线",
        engine="piper",
        supports_reference_audio=False,
    ),
    VoiceInfo(
