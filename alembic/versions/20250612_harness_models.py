...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "parent_segment_id",
            sa.Integer(),
            sa.ForeignKey("audio_segments.id"),
            nullable=True,
        ),
        sa.Column(
            "quality_id",
            sa.Integer(),
            sa.ForeignKey("qualities.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column("status", sa.String(), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column(
            "paragraph_id",
            sa.Integer(),
            sa.ForeignKey("legacy_paragraphs.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "tts_edit_id",
            sa.Integer(),
            sa.ForeignKey("legacy_tts_edits.id"),
            nullable=True,
        ),
...
def downgrade() -> None:
    ...
    paragraph_cols = [
        ...
        "routing_estimated_cost",
        "routing_estimated_duration",
        "quality_speaker_clarity",
        "quality_emotion_match",
        "quality_prosody_naturalness",
        "quality_text_audio_alignment",
        "quality_overall_score",
        "quality_issues",
        "quality_fix_suggestions",
        "quality_needs_regeneration",
        "audio_segment_id",
        "status",
    ]
